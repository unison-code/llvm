...
void initializeCleanUnisonMetadataPass(PassRegistry&);
...
void initializeMachineCodeStatsPass(PassRegistry&);
...
void initializeMemoryAliasPass(PassRegistry&);
...
void initializeUnisonDriverPass(PassRegistry&);
